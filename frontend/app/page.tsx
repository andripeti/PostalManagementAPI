...
export default function HomePage() {
  return (
    <div className="flex min-h-screen flex-col">
      <SiteHeader />
      {/* Hero Section */}
      <header className="relative flex min-h-[80vh] items-center justify-center pt-16">
        ...
        <div className="container relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
